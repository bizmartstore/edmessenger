...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#6a3fdc" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "EduChat" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "EduChat — Learn Together" },
      { name: "description", content: "A mobile-first classroom messenger: chat, share lessons, take quizzes, and check attendance." },
      { name: "author", content: "EduChat" },
      { property: "og:title", content: "EduChat — Learn Together" },
      { property: "og:description", content: "A mobile-first classroom messenger for students and educators." },
