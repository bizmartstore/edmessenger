...
import { LayoutDashboard, ClipboardList, BookOpen, CalendarCheck, Users, ArrowLeft, UserRound, Megaphone, FolderKanban, Images, Lightbulb, Gamepad2 } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/feedback", label: "Feedback", icon: Lightbulb },
