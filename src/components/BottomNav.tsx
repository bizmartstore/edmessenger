...
import { MessageCircle, BookOpen, ClipboardList, CalendarCheck, Home } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-40 safe-bottom pb-2 px-3 pointer-events-none">
      <div className="glass-card pointer-events-auto max-w-md mx-auto rounded-3xl px-2 py-2 flex items-center justify-between">
